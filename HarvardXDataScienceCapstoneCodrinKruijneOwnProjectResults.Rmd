...
(gha/capita)`) # Calculate net footprint by subtracting it from global biocapacity.
...
cluster_expl <- ggplot(raw_clustered, aes(x = `Happy Life Years`, y = 1.73 - `Footprint\r\n(gha/capita)`, size = `Happy Planet Index`, color = cluster)) + geom_point()
...
# Silhouette width method https://campus.datacamp.com/courses/cluster-analysis-in-r/k-means-clustering?ex=8
...
bi_plot_hpi <- ggplot(raw_clustered, aes(x = `Happy Life Years`, y = 1.73 - `Footprint\r\n(gha/capita)`, size = `Happy Planet Index`, color = final_cluster)) + geom_point()
saveRDS(bi_plot_hpi, "graphs/bi_plot_hpi.rds")

bi_plot_spi <- ggplot(raw_clustered, aes(x = `Happy Life Years`, y = 1.73 - `Footprint\r\n(gha/capita)`, size = `Social Progress Index`, color = final_cluster)) + geom_point()
saveRDS(bi_plot_spi, "graphs/bi_plot_spi.rds")
